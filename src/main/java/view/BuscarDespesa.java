...
public class BuscarDespesa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        despesaId = new javax.swing.JTable();
        ...
        jLabel1.setText("Buscar despesa");
        ...
        despesaId.setBackground(new java.awt.Color(153, 153, 153));
        despesaId.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(despesaId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarDespesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarDespesa().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable despesaId;
